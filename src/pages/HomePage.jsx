...
export default function HomePage() {
  return (
    <div className="bg-[#0f172a] text-white selection:bg-blue-500/30 overflow-x-hidden">
      ...
      {/* HERO SECTION */}
      <section className="relative relative min-h-[calc(100vh-80px)] flex items-center px-6 lg:px-20 py-20 z-10">
      ...
      <section className="py-32 px-6 relative">
        ...
        <div className="container mx-auto text-center relative z-10">
          <motion.div initial={{ scale: 0.9, opacity: 0 }} whileInView={{ scale: 1, opacity: 1 }}>
            <h2 className="text-5xl font-bold mb-8">Start Your Coding Journey Today</h2>
...
function Stat({ value, label, suffix }) {
  ...
  return (
    <div ref={ref}>
      ...
      <p className="text-slate-400 uppercase tracking-widest font-semibold">{label}</p>
    </div>
  );
}
